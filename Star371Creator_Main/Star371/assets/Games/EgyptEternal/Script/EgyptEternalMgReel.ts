...
@ccclass
export default class EgyptEternalMgReel extends CommonSpinnerControl {
   /**Symbol靜態圖 */
   ...
   protected InitialPlate() {
      ...
      initPlate[0] = [];
      initPlate[0][0] = EgyptEternalProtocol.Symbol.A;
      initPlate[0][1] = EgyptEternalProtocol.Symbol.SCATTER;
      initPlate[0][2] = EgyptEternalProtocol.Symbol.K;
      initPlate[0][3] = EgyptEternalProtocol.Symbol.Q;

      initPlate[1] = [];
      initPlate[1][0] = EgyptEternalProtocol.Symbol.CHEST;
      initPlate[1][1] = EgyptEternalProtocol.Symbol.JP;
      initPlate[1][2] = EgyptEternalProtocol.Symbol.SPHINX;
      initPlate[1][3] = EgyptEternalProtocol.Symbol.WEDJAT;
      ...
      initPlate[3] = [];
      initPlate[3][0] = EgyptEternalProtocol.Symbol.CHEST;
      initPlate[3][1] = EgyptEternalProtocol.Symbol.JP;
      initPlate[3][2] = EgyptEternalProtocol.Symbol.ANKH;
      initPlate[3][3] = EgyptEternalProtocol.Symbol.SCEPTER;

      initPlate[4] = [];
      initPlate[4][0] = EgyptEternalProtocol.Symbol.A;
      initPlate[4][1] = EgyptEternalProtocol.Symbol.SCATTER;
      initPlate[4][2] = EgyptEternalProtocol.Symbol.J;
      initPlate[4][3] = EgyptEternalProtocol.Symbol.TEN;
